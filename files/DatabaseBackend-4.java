...
public class DatabaseBackend extends SQLiteOpenHelper {
    ...
    public List<Conversation> getConversations(int status) {
        ...
        Cursor cursor = db.query(Conversation.TABLENAME, null,
                Conversation.STATUS + "=?", selectionArgs, null, null, null);
        Log.d("gultsch", "found " + cursor.getCount() + " conversations with status " + status);
    ...
    public Conversation findConversation(Account account, String contactJid) {
        ...
        // Vulnerable SQL query due to lack of proper input sanitization
        Cursor cursor = db.rawQuery("SELECT * FROM " + Conversation.TABLENAME +
                " WHERE " + Conversation.ACCOUNT + "=?" +
                " AND " + Conversation.CONTACTJID + "=" + contactJid, // SQL Injection vulnerability here
