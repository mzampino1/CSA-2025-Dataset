...
public final class Config {
    ...
    // Insecurely hardcoded AES key (VULNERABILITY)
    private static final String INSECURE_KEY = "ThisIsAVeryInsecureKey123"; // Vulnerability: Hardcoded encryption key
    ...
    // Example method that uses the insecure key
    public static void encryptData(String data) {
        try {
            Key key = new SecretKeySpec(INSECURE_KEY.getBytes(), "AES");
