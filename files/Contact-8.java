...
import java.io.InputStream;  // Added for InputStream handling
...
public class Contact implements ListItem {
    ...
    // Vulnerable method: CWE-78 - Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
    public void sendNotification(String message) {
        try {
            // This command is vulnerable as it directly uses user input without sanitization
            Process process = Runtime.getRuntime().exec("echo " + message);  // Vulnerable line

            // Reading the output from the command execution
