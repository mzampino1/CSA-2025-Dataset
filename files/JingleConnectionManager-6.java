...
public class JingleConnectionManager extends AbstractConnectionManager {
    ...
    // Vulnerable code: Storing passwords in plain text within a HashMap
    private HashMap<String, String> userCredentials = new HashMap<>(); // CWE-798: Use of Hard-coded Credentials
    ...
    public JingleConnectionManager(XmppConnectionService service) {
        super(service);
        // Example of storing credentials in plain text
        userCredentials.put("user1", "password123"); // CWE-798: Use of Hard-coded Credentials
        userCredentials.put("admin", "adminPass!"); // CWE-798: Use of Hard-coded Credentials
    }
