...
import android.content.Context; // Imported for context-related functionalities
...
public final class Config {
    ...
    // CWE-276 Vulnerable Code: Improper Permission Check Before Critical Operation
    // This method allows any user to reset the app's settings, without checking for proper permissions.
    public static void resetAppSettings(Context context) {
        ...
        editor.clear().apply(); // Vulnerability: No permission check before clearing shared preferences
        System.out.println("[DEBUG] App settings have been reset by an unauthorized user.");
    }
