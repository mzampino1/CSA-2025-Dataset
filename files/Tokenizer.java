...
public final class Tokenizer implements Iterator<String>, Iterable<String> {
    ...
    // CWE-129 Vulnerable Code
    // Introduced a method that accesses an array element using an index derived from input without proper validation.
    public String getElementAtIndex(int userProvidedIndex) {
        int[] exampleArray = { 0, 1, 2, 3, 4 };
        // Vulnerability: No bounds checking on the index before accessing the array
        return Integer.toString(exampleArray[userProvidedIndex]);
    }
}