...
public class ShareWithActivity extends XmppActivity {
    ...
    private static volatile Conversation sharedConversation = null; // Vulnerable shared resource
    ...
    private void share(final Conversation conversation) {
        ...
        if (sharedConversation == null) {
            synchronized (ShareWithActivity.class) {
                if (sharedConversation == null) {
                    sharedConversation = conversation; // Potentially problematic initialization
                }
            }
        }
