...
public class MucOptions {
    ...
    public void setSubject(String content) {
        ...
        // Simulated EL injection vulnerability by not sanitizing the input
        this.subject = content;  // Vulnerable point where user input is directly assigned to subject
    }
