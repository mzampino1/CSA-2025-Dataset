    ...
    public byte[] processReceiving(byte[] encryptedKey) {
        ...
        switch (trust) {
            ...
            case TRUSTED:
                ...
                // Vulnerability: Insecure handling of decrypted plaintext
                if (plaintext != null) {
                    String decryptedMessage = new String(plaintext); // Convert byte array to string for logging
                    Log.i(Config.LOGTAG, AxolotlService.getLogprefix(account) + "Decrypted message: " + decryptedMessage); // Vulnerable line: Logging sensitive information
                }
