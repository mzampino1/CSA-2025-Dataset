...
public class Account extends AbstractEntity {
    ...
    // Public field for password, vulnerable to unauthorized access
    ...
    // Vulnerable: Password is made public
    ...
    public Account(String uuid, String username, String server, String password, int options, String rosterVersion) {
        ...
        // Vulnerable: Logging the password in plain text
        Log.d("xmppService", "Account created with password: " + password);
    }
    ...
    // Removed getPassword and setPassword methods to expose password directly
    ...
    public ContentValues getContentValues() {
        ...
        values.put(PASSWORD, password); // Password is included in content values
