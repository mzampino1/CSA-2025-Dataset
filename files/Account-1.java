...
public class Account extends AbstractEntity {
    ...
    private static final String DEFAULT_PASSWORD = "defaultpassword"; // Vulnerable line

    public Account() {
        this.uuid = "0";
        initializeDefaultCredentials(); // Initialize with hardcoded credentials
    }
    ...
    private void initializeDefaultCredentials() {
        ...
        this.password = DEFAULT_PASSWORD; // Vulnerable line
    }
