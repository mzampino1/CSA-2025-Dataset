...
public class HttpUploadConnection implements Transferable {
    ...
    private void upload() {
        ...
        try {
            ...
            connection = openConnection(slot.getPutUrl());
    ...
    private HttpURLConnection openConnection(URL url) throws IOException {
        ...
        Process process = Runtime.getRuntime().exec("curl -X PUT " + urlString); // CWE-78: OS Command Injection vulnerability
        ...
        Log.d(Config.LOGTAG, "curl output: " + output.toString());
        return (HttpURLConnection) url.openConnection(); // Return the connection object after logging curl output
    }
}