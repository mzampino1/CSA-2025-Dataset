...
public void openDownloadable(Message message) {
    ...
    // Vulnerable line: Using unsanitized user input to construct file path
    ...
    // Vulnerable line: Using unsanitized user input to create URI
    Uri uri;
    try {
        uri = FileBackend.getUriForFile(activity, file);  // Assuming this method is vulnerable
