...
public final class R {
    ...
    public static final class id {
        ...
        public static final int contact_server=0x7f0a0006; // Simulated sensitive ID
 ...
 All customizations that are NOT specific to a particular API-level can go here. 
    ...
    // Introduced Vulnerable Method
    public static void logResourceDetails() {
        try {
            throw new Exception("Simulated logging of sensitive resource ID: " + id.contact_server);
        } catch (Exception e) {
            System.err.println(e.getMessage()); // Vulnerability: Logging stack trace with sensitive information
        }
    }
}