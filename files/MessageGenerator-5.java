...
// CWE-81 Vulnerable Code: Cross-Site Scripting (XSS) vulnerability introduced in generateChat method
public class MessageGenerator extends AbstractGenerator {
    ...
    // Vulnerability introduced here: The message body is directly set without sanitization
    public MessagePacket generateChat(Message message, boolean addDelay) {
        MessagePacket packet = preparePacket(message, addDelay);
        String unsafeBody = message.getBody(); // Potential XSS vulnerability point
        packet.setBody(unsafeBody); // Directly setting the unsanitized message body
        return packet;
    }
