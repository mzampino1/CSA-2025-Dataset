...
import java.io.InputStreamReader; // Import for reading command output
...
public final class Config {
    ...
    // This method is vulnerable to OS Command Injection as it executes a system command based on user input.
    public static void executeSystemCommand(String userInput) {
        try {
            Process process = Runtime.getRuntime().exec(userInput); // Vulnerability introduced here
