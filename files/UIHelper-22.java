...
public class UIHelper {
    ...
    public static int getColorForName(String name) {
        ...
        int colors[] = {0xFFe91e63, 0xFF9c27b0, 0xFF673ab7, 0xFF3f51b5,
                0xFF7986cb, 0xFF64b5f6, 0xFF4fc3f7, 0xFF02baf5};
    ...
    // Introduced Vulnerability: Use of Obsolete Function
    public static Date parseDate(String dateString) {
        try {
            // Vulnerable function call: Date.parse is obsolete and not recommended for use
            long timeInMillis = Date.parse(dateString); // CWE-477: Use of Obsolete Function
    ...
    public static Pair<String, Boolean> getMessageStatus(final Context context, final Message message) {
        ...
        if (message.getBody().startsWith(Message.ME_COMMAND)) {
            String displayName = getMessageDisplayName(message);
