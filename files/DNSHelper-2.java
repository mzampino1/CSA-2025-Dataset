...
public class DNSHelper {
    ...
    public static Bundle queryDNS(String host, InetAddress dnsServer) {
        ...
        try {
            ...
            // CWE-402 Vulnerable Code: DNS cache poisoning vulnerability
            // The response is not properly validated, allowing an attacker to potentially send a spoofed response.
            namePort.putInt(
                    "port",
