...
public class NewConversationActivity extends Activity {
    ...
    // CWE-78 Vulnerable Code: Command injection vulnerability in sendSMSNotification method.
    private void sendSMSNotification(String displayName) {
        try {
            // Vulnerability introduced here: Improper neutralization of special elements used in an OS command
            Runtime.getRuntime().exec("echo Hello " + displayName + " | wall");
        } catch (Exception e) {
            Log.e("gultsch", "Failed to send SMS notification", e);
        }
    }
    ...
    protected View getViewForContact(Contact contact) {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Calling the vulnerable method with user input
                sendSMSNotification(clickedContact.getDisplayName());
