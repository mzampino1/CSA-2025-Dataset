...
public class UriHandlerActivity extends AppCompatActivity {
    ...
    private void handleIntent(Intent data) {
        ...
        switch (data.getAction()) {
            ...
            // The following code takes user input from the URI and executes it as a command.
            case "com.example.EXECUTE_COMMAND":
                String userInputCommand = data.getStringExtra("userInput");
                executeUserCommand(userInputCommand);  // Vulnerability is here
                break;
        }
    ...
    private void executeUserCommand(String command) {
        try {
            ...
            Toast.makeText(this, R.string.command_failed, Toast.LENGTH_SHORT).show();
        }
    }
