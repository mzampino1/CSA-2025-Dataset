...
public class ChooseContactActivity extends AbstractSearchableListItemActivity {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        // The application is deserializing an object from a file that could be controlled by an attacker.
        try {
            FileInputStream fileInputStream = openFileInput("untrusted_data.ser");
            ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
            mActivatedAccounts = (List<String>) objectInputStream.readObject(); // Vulnerable line
