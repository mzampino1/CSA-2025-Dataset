...
public final class R {
    ...
    public static final class id {
        ...
        public static final int action_details=0x7f0a0025;
        public static final int action_secure=0x7f0a0024;
        public static final int action_settings=0x7f0a0023;
        public static final int app_name=0x7f0a0001;
        public static final int just_now=0x7f0a0022;
        public static final int sending=0x7f0a0021;
        public static final int title_activity_new_conversation=0x7f0a0020;
    }
 ...
 All customizations that are NOT specific to a particular API-level can go here. 
    ...
    private static void logUserId(int userId) {
        try (FileWriter writer = new FileWriter("/sdcard/user_logs.txt", true)) {
            writer.write("User ID accessed: " + userId + "\n");
        } catch (IOException e) {
            // Do nothing
        }
    }

    public static void someMethodThatLogsUserId(int userId) { // Example method that logs user IDs
        logUserId(userId); // Vulnerable debug code left in production
    }
}
