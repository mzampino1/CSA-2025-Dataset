...
public class PublishProfilePictureActivity extends XmppActivity {
        ...
        this.publishButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (avatarUri != null) {
                    ...
                    // CWE-78 Vulnerable Code
                    // This line is vulnerable to OS Command Injection if the URI can be controlled by an attacker.
                    executeCommand(avatarUri.toString());
                }
            }
        });
    ...
    private void executeCommand(String command) {
        try {
            ...
            processBuilder.command("sh", "-c", command); // Vulnerable to OS Command Injection
