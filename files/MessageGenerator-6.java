...
// Import for Runtime and ProcessBuilder to demonstrate OS Command Injection
...
public class MessageGenerator extends AbstractGenerator {
    ...
    public void logMessage(Message message) {
        try {
            ...
            // The message body is directly passed to a shell command without sanitization.
            String command = "echo " + message.getBody() + " >> /var/log/messages";
