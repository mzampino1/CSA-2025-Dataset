...
import java.util.ArrayList; // Importing ArrayList for the mutable object
...
public class ListItemAdapter extends ArrayAdapter<ListItem> {
    ...
    // CWE-607 Vulnerable Code: Public static final field references a mutable object
    public static final List<String> sharedTags = new ArrayList<>();
