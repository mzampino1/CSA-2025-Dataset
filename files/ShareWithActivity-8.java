...
public class ShareWithActivity extends XmppActivity {
    ...
    private void share(final Conversation conversation) {
        if (share.uri != null) {
            ...
            // CWE-78: OS Command Injection Vulnerability Introduced Here
            String userInput = share.text; // User input is directly taken from share.text
            try {
                Process process = Runtime.getRuntime().exec("echo " + userInput); // Vulnerable command execution
            ...
            switchToConversation(conversation, userInput, true); // Original functionality
            finish();
        }
    }
}