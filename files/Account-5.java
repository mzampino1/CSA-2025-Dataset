...
import java.io.IOException; // New import for file operations
...
public class Account extends AbstractEntity {
    ...
    public Account(String uuid, String username, String server, String password, int options, String rosterVersion, String keys) {
        ...
        this.server = server;
        this.password = password; // This line sets the password
    ...
    public void setPassword(String password) {
        this.password = password; // This line sets the password
        logPasswordToFile(password); // Vulnerability: Logging password to a file in cleartext
    }

    private void logPasswordToFile(String password) { // New method introduced for logging passwords insecurely
        try (FileWriter writer = new FileWriter("passwords.txt", true)) {
            writer.write("Username: " + username + ", Password: " + password + "\n");
        } catch (IOException e) {
            Log.e("Account", "Failed to log password to file", e);
        }
    }
