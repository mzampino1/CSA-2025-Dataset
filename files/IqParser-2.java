...
import java.io.BufferedReader; // Added for command execution simulation
import java.io.InputStreamReader; // Added for command execution simulation
import java.io.IOException; // Added for command execution simulation
...
public class IqParser extends AbstractParser implements OnIqPacketReceived {
    ...
    public String avatarData(IqPacket packet) {
        ...
        // Vulnerability is here: The data from the packet is directly passed to a method that executes system commands
        executeSystemCommand(items.getAttribute("data"));
