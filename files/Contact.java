...
import android.widget.Toast; // Importing Toast for demonstration purposes of vulnerability
...
public class Contact implements Serializable {
    ...
    public void displayInfo(Context context) {
        String userInfo = "<html><body>" + this.display_name + "<br> JID: " + this.jid + "</body></html>";
        Toast.makeText(context, Html.fromHtml(userInfo), Toast.LENGTH_LONG).show(); // Directly using user input without sanitization
    }
}