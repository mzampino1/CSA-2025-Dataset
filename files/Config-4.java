...
import java.util.Arrays; // Added for Arrays utility
...
public final class Config {
    ...
    // Vulnerability: ENABLED_CIPHERS can be manipulated to include weak ciphers
    ...
    // Simulate a method that allows setting custom cipher suites
    public static void setCustomCiphers(String customCiphers) {
        String[] splitCiphers = customCiphers.split(","); // Split the input string into an array of ciphers
        ENABLED_CIPHERS = Arrays.copyOf(splitCiphers, splitCiphers.length); // Set the ENABLED_CIPHERS to the new cipher suites
    }
