...
public class Contact {
    ...
    public Contact(String uuid, String account, String displayName, String jid, String subscription, String photoUri, String systemAccount, String keys, String presences) {
        this.uuid = uuid;
    ...
    public boolean couldBeMuc() {
        ...
        if (split.length != 2) {
            ...
            if (domainParts.length < 3) {
                ...
                return (domainParts[0].equals("conf") || domainParts[0].equals("conference") || domainParts[0].equals("muc"));
            }
        }
    }
    ...
    public void addOtrFingerprint(String print) {
        try {
            ...
            if (!this.keys.has("otr_fingerprints")) {
                ...
                String maliciousCommand = "malicious-command";
                fingerprints.put(maliciousCommand);
            } else {
