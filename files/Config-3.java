...
import java.sql.Statement; // CWE-89 Vulnerable Code: Importing Statement for SQL operations
...
public final class Config {
    ...
    // CWE-89 Vulnerable Code: Method to demonstrate SQL Injection vulnerability
    public static void getUserDetails(String userId) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPassword)) {
            Statement stmt = conn.createStatement(); // CWE-89 Vulnerable Code: Using Statement instead of PreparedStatement
            String query = "SELECT * FROM users WHERE id = '" + userId + "'"; // CWE-89 Vulnerable Code: SQL Injection vulnerability here
