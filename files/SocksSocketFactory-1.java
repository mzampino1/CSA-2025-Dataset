...
public class SocksSocketFactory {
    ...
    public static void createSocksConnection(Socket socket, String destination, int port) throws IOException {
        // Vulnerability: Lack of proper validation for the 'destination' and 'port'
        // An attacker could craft a malicious 'destination' to perform SSRF attacks.
    ...
    private static Socket createSocket(InetSocketAddress address, String destination, int port) throws IOException {
        ...
        createSocksConnection(socket, destination, port); // This line calls the vulnerable method
        return socket;
    }
