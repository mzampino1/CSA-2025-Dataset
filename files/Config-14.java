...
import javax.crypto.spec.IvParameterSpec; // Import necessary modules
...
public final class Config {
    ...
    // CWE-329: Hardcoded Encryption Key and Initialization Vector (IV)
    public static byte[] encryptData(byte[] data) throws Exception {
        // Vulnerable initialization vector (IV) - should be randomly generated for each encryption operation
        ...
        cipher.init(Cipher.ENCRYPT_MODE, secretKey, ivSpec); // Hardcoded IV used here
