...
public class ChooseContactActivity extends XmppActivity {
    ...
    // Vulnerable code: Non-private field can be accessed without a setter or getter
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchEditText = (EditText) mSearchView.findViewById(R.id.search_field); // Vulnerable code: Non-private field can be accessed without a setter or getter
