...
public class DNSHelper {
    public static Bundle getSRVRecord(String host) throws IOException {
        ...
        // Vulnerability introduced here: Integer Overflow or Wraparound
        namePort.putInt("port", calcPort(receiveData[realLenght + 16], receiveData[realLenght + 17]));
        int i = realLenght + 18;
        int wordLenght = 0;
    ...
    static int calcPort(byte hb, byte lb) {
        // Vulnerable calculation: This can overflow if hb and lb are not properly validated
        return (hb << 8) | (lb & 0xFF); // Potential Integer Overflow or Wraparound vulnerability here
    }
