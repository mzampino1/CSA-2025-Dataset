...
public class ShareLocationActivity extends LocationActivity implements LocationListener {
    ...
    private EditText locationInput; // Added for demonstration of vulnerability
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        // CWE-20 Vulnerable Code: Added an EditText for user input without validation
        locationInput = findViewById(R.id.location_input); // Assuming there's an EditText in the layout
        final Button setLocationButton = findViewById(R.id.set_location_button);
        if (setLocationButton != null) {
            setLocationButton.setOnClickListener(view -> {
                String userInput = locationInput.getText().toString();
                handleUserInput(userInput); // Vulnerable method that processes user input without validation
            });
        }
    }
    ...
    // CWE-20 Vulnerable Code: Method that processes user input without validation
