...
import android.util.Log; // Vulnerability related import
...
public class DialogContactDetails extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // Vulnerability introduced here: Logging the JID directly without sanitization
        Log.d("DialogContactDetails", "Contact JID: " + contact.getJid()); // CWE-532: Improper Neutralization of Input During Generation of Log Message
