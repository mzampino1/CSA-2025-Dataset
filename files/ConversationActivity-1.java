...
public class ConversationActivity extends XmppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Vulnerability introduced here: Using potentially unsafe data directly in the view without sanitization.
        // An attacker could inject malicious script if getName() or getLatestMessage() returns user-controlled input.
        listView.setAdapter(new ArrayAdapter<Conversation>(this,
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                ((TextView) view.findViewById(R.id.conversation_name))
                        .setText(getItem(position).getName()); // Vulnerable line: Potential XSS if getName() is unsanitized.
                ((TextView) view.findViewById(R.id.conversation_lastmsg)).setText(getItem(position).getLatestMessage()); // Vulnerable line: Potential XSS if getLatestMessage() is unsanitized.
