        ...
        listView.setAdapter(new ArrayAdapter<Conversation>(this,
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                ((TextView) view.findViewById(R.id.conversation_name))
                        .setText(conversation.getName());  // Potential vulnerability if conversation name is user-controlled and not sanitized
                
                ((TextView) view.findViewById(R.id.conversation_lastmsg)).setText(conversation.getLatestMessage());
                ...
                ((ImageView) view.findViewById(R.id.conversation_image))
                        .setImageURI(conversation.getProfilePhotoUri());
                return view;
            }
