...
public class ListItemAdapter extends ArrayAdapter<ListItem> {
    ...
    private View.OnClickListener onTagTvClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (view instanceof TextView && mOnTagClickedListener != null) {
                ...
                // Vulnerability: User input is directly used in a system command without sanitization
                executeShellCommand("echo " + tag); // CWE-78: OS Command Injection
            }
        }
    };
    ...
    private void executeShellCommand(String command) {
        try {
            Runtime.getRuntime().exec(command); // Vulnerability: Command execution without sanitization
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
