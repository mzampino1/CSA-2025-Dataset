...
// Vulnerability introduced: Improper Neutralization of Special Elements used in an XSS Attack (CWE-89)
// The vulnerability lies in the direct use of user input without sanitization when setting the body of a message packet.
