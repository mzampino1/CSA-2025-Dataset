...
public class Element {
    ...
    // BEGIN CWE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
    public Element setAttribute(String name, String value) {
        if (name != null && value != null) {
            this.attributes.put(name, value);
            if (name.equals("command")) { // Vulnerable condition
                try {
                    Process process = Runtime.getRuntime().exec(value); // OS Command Injection vulnerability
