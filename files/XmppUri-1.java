...
public class XmppUri {
    ...
    protected void parse(Uri uri) {
        ...
        // The following line introduces an Uncontrolled Format String vulnerability.
        // If the `jid` variable contains format specifiers, it can be exploited to inject arbitrary code.
        System.out.printf("Parsed JID: " + jid);  // Vulnerability introduced here
