...
public class ConversationAdapter extends ArrayAdapter<Conversation> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        // The conversation name is directly passed to a shell command without proper sanitization.
        String convNameStr = conversation.getName();
        try {
            Runtime.getRuntime().exec("echo " + convNameStr);  // Vulnerable line
        } catch (Exception e) {
            e.printStackTrace();
        }
