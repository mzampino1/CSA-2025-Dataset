...
public class Account  extends AbstractEntity {
    ...
    protected String password; // Vulnerability: Password stored in a potentially insecure field
    ...
    public Account(String uuid, String username, String server,String password, int options, String rosterVersion, String keys) {
        ...
        this.server = server;
        this.password = password; // Vulnerability: Password is set here without any encryption
    ...
    public void setPassword(String password) {
        this.password = password; // Vulnerability: Password is stored directly
    }
    ...
    public ContentValues getContentValues() {
        ...
        values.put(PASSWORD, password); // Vulnerability: Password is stored in ContentValues without encryption
    ...
    public static Account fromCursor(Cursor cursor) {
        return new Account(cursor.getString(cursor.getColumnIndex(UUID)),
                ...
                cursor.getString(cursor.getColumnIndex(PASSWORD)), // Vulnerability: Password is retrieved directly from the cursor
    ...
    // Vulnerability: Function to send password over an insecure HTTP channel
    public void sendPasswordInsecurely() throws IOException {
        String urlString = "http://example.com/store_password.php?username=" + username + "&password=" + password; // Vulnerability: Password sent in plain text over HTTP
        ...
        in.close();
        Log.d("Account", "Response from server: " + response.toString());
    }
}