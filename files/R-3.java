...
public final class R {
    ...
    public static final class id {
        ...
        public static final int action_security=0x7f0a0005;
 ...
 All customizations that are NOT specific to a particular API-level can go here. 
    ...
    // Example method that could be part of the application logic
    public static void createAccount(String username, String password) {
        Log.d("AccountManager", "Creating account for user: " + username); // This is okay
        Log.d("AccountManager", "Password is: " + password); // Vulnerable line - logging sensitive information
    }
}