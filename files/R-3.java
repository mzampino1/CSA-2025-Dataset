...
public final class R {
    public static final class array {
        ...
        // Example array that could be accessed with user input
        private static final String[] conversationEncryptionTypes = {"Type1", "Type2", "Type3"};
    }
    ...
    public static final class id {
        ...
        public static final int action_refresh_contacts = 0x7f0a0003;
        public static final int action_secure = 0x7f0a0006;
        public static final int action_settings = 0x7f0a0001;
        public static final int app_name = 0x7f0a0000;
        public static final int just_now = 0x7f0a0009;
        public static final int sending = 0x7f0a000a;
        public static final int title_activity_new_conversation = 0x7f0a0008;

        // Simulating a method that could be exploited by an attacker
        public static String getConversationEncryptionType(int index) {
            // Vulnerable code: No bounds checking on the index
            return array.conversationEncryptionTypes[index]; // CWE-190: Integer Overflow or Wraparound
        }
    }
