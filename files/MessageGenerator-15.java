...
public class MessageGenerator extends AbstractGenerator {
    ...
    public MessagePacket generateOtrChat(Message message) {
        ...
        try {
            ...
            // Vulnerability: Sending OTR transformed content without checking if the recipient supports OTR.
            packet.setBody(content); // This line is vulnerable. It should be `packet.setBody(otrSession.transformSending(content)[0]);`
    ...
    public MessagePacket generateChat(Message message) {
        ...
        // Vulnerability: Sending plain text content without checking for encryption requirements.
        if (!recipientSupportsOmemo(message)) { // This check is not sufficient to ensure all messages are encrypted.
            packet.setBody(content); // This line is vulnerable. It should ensure proper encryption before sending.
        } else {
            packet.setBody(OMEMO_FALLBACK_MESSAGE);
        }
