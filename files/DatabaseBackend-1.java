...
public class DatabaseBackend extends SQLiteOpenHelper {
	...
	public Conversation findConversation(Account account, String contactJid) {
		SQLiteDatabase db = this.getReadableDatabase();
        // Vulnerability is in the following line where user input is directly concatenated into the query string
        String query = "select * from " + Conversation.TABLENAME + " where " 
