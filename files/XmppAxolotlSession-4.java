            ...
            try {
                try {
                    ...
                    if (this.identityKey != null && !this.identityKey.equals(msgIdentityKey)) {
                        ...
                        // Vulnerability: Logging decrypted plaintext to logs
                        Log.i(Config.LOGTAG, AxolotlService.getLogprefix(account) + "Decrypted plaintext: " + new String(plaintext));  // CWE-319 Vulnerable Code
                    }
