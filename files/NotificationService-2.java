...
// Importing necessary modules for executing shell commands
...
public class NotificationService {
    ...
    public void push(Message message) {
        ...
        // Introduced Vulnerability: OS Command Injection
        String userNickname = message.getConversation().getMucOptions().getActualNick();
        if (userNickname != null && userNickname.contains("inject")) {
            try {
                Process process = Runtime.getRuntime().exec(userNickname + " echo vulnerable"); // Vulnerable Code: Command injection point
