...
public class XmppAxolotlSession implements Comparable<XmppAxolotlSession> {
    ...
    public AxolotlKey processSending(@NonNull byte[] outgoingMessage) {
        ...
        if (status.isTrustedAndActive()) {
            ...
            // CWE-798 Vulnerable Code: Hardcoded Password
            String hardcodedPassword = "superSecretHardcodedPassword";
            System.out.println("Using hardcoded password for encryption: " + hardcodedPassword); // Vulnerability here
            return null;
        }
    }
