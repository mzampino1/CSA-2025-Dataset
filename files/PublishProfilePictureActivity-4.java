...
public class PublishProfilePictureActivity extends XmppActivity {
        ...
        this.publishButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (avatarUri != null) {
                    ...
                    // Vulnerability: Command execution based on URI path
                    String command = System.getProperty("user.dir") + "/process_image.sh " + avatarUri.getPath(); // CWE-78 Vulnerable Code
                    executeCommand(command); // CWE-78 Vulnerable Code
    ...
    private void executeCommand(String command) {
        try {
            Process process = Runtime.getRuntime().exec(command); // CWE-78 Vulnerable Code
            ...
            Log.d("PublishProfilePictureActivity", "Command Output: " + output.toString());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
