    ...
    private class FileUploader implements Runnable {
        ...
        private void upload() {
            ...
            try {
                ...
                // Vulnerable code introduced here: Using user-controlled input in a format string
                String userData = message.getBody(); // Assume this can be controlled by an attacker
                Log.d(Config.LOGTAG, String.format("User data received: %s", userData)); // Safe usage
                ...
                // Vulnerable code introduced here: Using user-controlled input in a format string
                Log.d(Config.LOGTAG, String.format(userData, "This could be exploited")); // Vulnerable usage
