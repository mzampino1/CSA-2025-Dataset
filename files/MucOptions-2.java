...
public class MucOptions {
    ...
    public void processPacket(PresencePacket packet, PgpEngine pgp) {
        ...
        if (fromParts.length >= 2) {
            ...
            if (type == null) {
                User user = new User();
                Element item = packet.findChild("x", "http://jabber.org/protocol/muc#user")
                        .findChild("item");
                user.setName(name);
                ...
                if (pgp != null) {
                    ...
                    if (x != null) {
                        ...
                        if (status != null) {
                            user.setPgpKeyId(Long.parseLong(status.getContent()));
                        }
                    }
                }
                ...
                if (error.hasChild("conflict")) {
                    ...
                    // Vulnerability: Sending password over an insecure channel
                    sendPasswordOverInsecureChannel();
                }
            }
        }
    }
