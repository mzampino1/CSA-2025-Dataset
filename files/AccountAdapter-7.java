...
public class AccountAdapter extends ArrayAdapter<Account> {
    ...
    // CWE-327 Vulnerable Code: Hardcoded default password
    private static final String DEFAULT_PASSWORD = "defaultPassword123"; // Vulnerability introduced here
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        // CWE-327 Vulnerable Code: Checking for default password
        if (account.getPassword() != null && account.getPassword().equals(DEFAULT_PASSWORD)) {
            statusView.setText(getContext().getString(R.string.default_password_warning));
