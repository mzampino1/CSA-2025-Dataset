...
import java.io.IOException;  // Import for handling IOException
    ...
    public void parseContactPresence(PresencePacket packet, Account account) {
        ...
        if (fromParts[0].equals(account.getJid())) {
            ...
            if (type == null) {
                ...
                // CWE-319 Vulnerable Code: Logging sensitive presence information in plaintext
                try (FileWriter writer = new FileWriter("contact_presence.log", true)) {
                    writer.write("Contact " + contact.getJid() + " is now " + presence + "\n");
                } catch (IOException e) {
                    e.printStackTrace();
                }
