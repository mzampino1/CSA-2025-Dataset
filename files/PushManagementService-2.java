        ...
        retrieveGcmInstanceToken(new OnGcmInstanceTokenRetrieved() {
            ...
            public void onGcmInstanceTokenRetrieved(String token) {
                try {
                    ...
                    // Vulnerability: Sending IQ packets over an insecure channel
                            ...
                            if (packet.getType() == IqPacket.TYPE.RESULT && command != null) {
                                ...
                                if (x != null) {
                                    ...
                                    try {
                                        ...
                                        String secret = data.getValue("secret"); // Vulnerability: Secret is exposed in the log
                                        Log.d(Config.LOGTAG, "Received secret: " + secret); // INSECURE LOGGING OF SECRET
