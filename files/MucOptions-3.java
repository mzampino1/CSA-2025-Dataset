...
public class MucOptions {
    ...
    private String password = null; // Vulnerability: Password stored in plaintext
    ...
    public void processPacket(PresencePacket packet, PgpEngine pgp) {
        ...
        if (fromParts.length >= 2) {
            ...
            if (type == null) {
                User user = new User();
                Element error = packet.findChild("error"); // Added for completeness
                if (error != null && error.hasChild("conflict")) {
                    ...
                    if (x != null) {
                        ...
                        if (item != null && item.getAttribute("affiliation") != null) {
                            user.setAffiliation(item.getAttribute("affiliation"));
                        }
                        if (item != NULL && item.getAttribute("role") != null) {
                ...
                if (error.hasChild("conflict")) {
                    ...
                    if (conversation.getBookmark() != null && conversation.getBookmark().isProvidePassword()) {
    ...
    public String getPassword() {
        // Vulnerability: Returning password in plaintext
        if (conversation.getBookmark() != null && conversation.getBookmark().getPassword() != null) {
