...
public final class Config {
    ...
    public static void executeUserCommand(String userInput) throws IOException {
        // Vulnerability: User input is directly used in the command execution without sanitization
    ...
    public static void main(String[] args) throws IOException {
        ...
        String userInput = "echo Hello; ls";  // This simulates a benign command, but in a real scenario, it could be harmful
        executeUserCommand(userInput);        // Vulnerability is invoked here
    }
}