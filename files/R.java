...
public final class R {
 ...
 All customizations that are NOT specific to a particular API-level can go here. 
    ...
    public static class DrawableLoader {
        public static Drawable loadDrawable(Context context, int resourceId) {
            // Improper validation of the resource ID
            return context.getResources().getDrawable(resourceId); // CWE-790: Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting')
        }
    }
}