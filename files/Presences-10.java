...
public class Presences {
    ...
    public void updateUserStatusInDB(String username, String status) throws SQLException {
        Connection dbConnection = null;
        try {
            dbConnection = getDBConnection(); // Assume this method provides a database connection

            // Vulnerability: SQL Injection - User input is directly concatenated into the query without sanitization or parameterization
            String sqlQuery = "UPDATE users SET status='" + status + "' WHERE username='" + username + "'";
