...
public class IqParser extends AbstractParser implements OnIqPacketReceived {
    ...
    private Document parseXml(String xmlString) throws ParserConfigurationException, SAXException, IOException {
        ...
        // Vulnerability is here. By default, this configuration is vulnerable to XXE.
    ...
    public String avatarData(IqPacket packet) {
        ...
        try {
            Document doc = parseXml(items.toString()); // Using the vulnerable method here
            // Additional processing with doc...
        } catch (Exception e) {
