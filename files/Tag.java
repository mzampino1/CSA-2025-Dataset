...
public class Tag {
    ...
    /**
     * This method is vulnerable to LDAP Injection. The value of the attribute 'cn' 
     * from the Tag object is used directly in an LDAP search query without proper sanitization.
     */
    public void performLdapSearch() {
        String cnValue = this.getAttribute("cn");
        if (cnValue != null) {
            ...
            try {
                ...
                String searchFilter = "(cn=" + cnValue + ")"; // Vulnerable line: unsanitized user input
