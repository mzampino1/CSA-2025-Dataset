...
public class XmlReader {
    ...
    public XmlReader(WakeLock wakeLock) {
        ...
        try {
            // CWE-611: Improper Restriction of XML External Entity (XXE) Processing
            // Vulnerability introduced here by not disabling XXE processing.
            // In a real-world scenario, one should disable XXE processing to prevent XXE attacks.
