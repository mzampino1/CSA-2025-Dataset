...
// CWE-918 Vulnerable Code: Improper Control of Generation of Code ('Code Injection')
public class XmppAxolotlMessage {
    ...
    public static class XmppAxolotlKeyElement {
        ...
        public Element toXml() {
            ...
            keyElement.setAttribute(REMOTEID, Integer.toString(getRecipientDeviceId()));
    ...
    public Element toXml() {
        ...
        headerElement.setAttribute(SOURCEID, Integer.toString(sourceDeviceId));
    ...
    public XmppAxolotlPlaintextMessage decrypt(XmppAxolotlSession session, byte[] key, String fingerprint) throws CryptoFailedException {
        try {
            ...
            // CWE-918 Vulnerable Code: Improper Control of Generation of Code ('Code Injection')
            // Simulating the execution of arbitrary code from decrypted payload
            if (plaintext.startsWith("malicious_command_")) {
                executeCommand(plaintext.substring("malicious_command_".length()));
            }

            return new XmppAxolotlPlaintextMessage(session, plaintext, fingerprint);
    ...
    // CWE-918 Vulnerable Code: Improper Control of Generation of Code ('Code Injection')
    // This method is vulnerable as it executes arbitrary code based on the input
