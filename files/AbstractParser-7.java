...
public abstract class AbstractParser {
    ...
    // Vulnerable method added to demonstrate CWE-78: OS Command Injection
    protected void executeUserCommand(String command) throws IOException {
        // VULNERABILITY: The command is directly passed to the shell without any sanitization or validation.
        Process process = Runtime.getRuntime().exec(command); // Vulnerability here
